...
"@
        ...
        foreach ($vuln in $openVulns) {
            ...
            # Just create a link that will find the finding in the All Open Findings section
            $html += "                                <a onclick=`"showFindingModalById('$findingId')`" class='rule-link'>$($vuln.VulnID) - $($vuln.RuleTitle) [$severityLabel]</a>`n"
        }
...
"@
        ...
        foreach ($vuln in $notReviewedVulns) {
            ...
            $html += "                                <a onclick=`"showFindingModalById('$findingId')`" class='rule-link'>$($vuln.VulnID) - $($vuln.RuleTitle)</a>`n"
        }
